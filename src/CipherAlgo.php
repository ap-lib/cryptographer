...
enum CipherAlgo: string
{
    ...
    public function isAllowedMetadata(): bool
    {
        return match ($this) {
            self::aes_128_ccm, self::aes_192_ccm, self::aes_256_ccm, self::aria_128_ccm, self::aria_192_ccm,
            self::aria_256_ccm, self::aes_128_gcm, self::aes_192_gcm, self::aes_256_gcm, self::aria_128_gcm,
            self::aria_192_gcm, self::aria_256_gcm, self::aes_128_ocb, self::aes_192_ocb, self::aes_256_ocb,
            self::chacha20_poly1305 => true,
            default => false
        };
    }

    public function isRequiredTag(): bool
    {
        return $this->isAllowedMetadata();
    }

    /**
     * @return int[]
     * @throws TagNotUsedException
     */
